...
public class HotelPositioningSystemActivity extends AppCompatActivity {
ImageView gym,library,canteen,livingroom,chart,map;
...
SensorData sensorData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotel_positioning_system);
       // addDatatoFirebasef();
        ...
        gym.setOnClickListener(v -> {
            startActivity(new Intent(this,HotelGymActivity.class));
        });
        ...
        chart.setOnClickListener(v -> {
            startActivity(new Intent(this, HotelTableActivity.class));
        });
    ...
    private void addDatatoFirebasef() {
        ...
        databaseReferencedis.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Toast.makeText(HotelPositioningSystemActivity.this, "added successfully", Toast.LENGTH_SHORT).show();
            }
