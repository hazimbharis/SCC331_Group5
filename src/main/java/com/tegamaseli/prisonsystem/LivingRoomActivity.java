    ...
    private BluetoothDevice getMicroBitDevice() {
        ...
        bluetoothAdapter.startLeScan(new BluetoothAdapter.LeScanCallback() {
            ...
            public void onLeScan(final BluetoothDevice device, int rssi, byte[] scanRecord) {
                ...
                if (ActivityCompat.checkSelfPermission(LivingRoomActivity.this, android.Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
                    // TODO: Consider calling
                    //    ActivityCompat#requestPermissions
                    // here to request the missing permissions, and then overriding
                    //   public void onRequestPermissionsResult(int requestCode, String[] permissions,
                ...
                if (device != null && device.getName() != null && device.getName().equals("BBC micro:bit")) {
                    ...
                    if (ActivityCompat.checkSelfPermission(LivingRoomActivity.this, android.Manifest.permission.BLUETOOTH_SCAN) != PackageManager.PERMISSION_GRANTED) {
                        // TODO: Consider calling
                        //    ActivityCompat#requestPermissions
                        // here to request the missing permissions, and then overriding
                        //   public void onRequestPermissionsResult(int requestCode, String[] permissions,
