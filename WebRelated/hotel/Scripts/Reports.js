...
function meansChart(type, title, yTitle) {
    ...
    if (zoneCount === 0) { //Fix for donwloading report with no data
        cData.addColumn("number", "No zones");
...
function download() {
    ...
    var elementsY = [20, 25, 35, 40, 45, 50, 116, 121, 126, 131];
    var ims = [uTChartI, mCChartI, dCChartI, tMChartI, lMChartI];
    var imsX = [100, 150, 10, 10, 10];
    var imsY = [20, 20, 55, 131, 187];
    var imsXS = [50, 50, 190, 190, 190];
    var imsYS = [50, 50, 56, 56, 56];
    ...
    pdf.addPage();
    pdf.addImage(sMChartI, "png", 10, 10, 190, 56);
    pdf.text(document.getElementById("noOfDoors").textContent, 10, 71);
    pdf.addImage(dHChartI, 10, 71, 190, 56);
    pdf.save("report.pdf");
}         