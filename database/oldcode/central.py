...
# Channel 1: Percentage of fluid left in smart cup
# Channel 2: ID and current zone of person

OBJECTS = ["Chair", "Door", "Switch"]
activeZones = [[], [], []]
nowActive = [0, 0, 0]
lastActive = [0 , 0, 0]
...
def main():
    ...
    while(1):   
        ...
        if message is not None:
            ...
            if int(serialMessage[0]) == 1:
                if (serialMessage[1] == "t"):
                    print("1:,Tilt:"+serialMessage[2])
                else: print("1:,Percent:"+serialMessage[1])
